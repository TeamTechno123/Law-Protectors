            ...
            <div class="card-body" >
              <form role="form" action="<?php echo base_url(); ?>/Transaction/save_process_step_two" method="post">
                ...
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-6 ">
                    <input type="text" class="form-control form-control-sm" name="GOVT_FEES" id="GOVT_FEES" value="<?php if(isset($GOVT_FEES)){ echo $GOVT_FEES;} ?>" title="Govt Fees" placeholder="Govt Fees" required>
                  </div>
                  <div class="form-group col-md-6 ">
                    <input type="text" class="form-control form-control-sm" name="TDS" id="TDS" value="<?php if(isset($TDS)){ echo $TDS;} ?>" title="TDS" placeholder="TDS">
                  </div>
                  <div class="form-group col-md-6 ">
                    <input type="text" class="form-control form-control-sm" name="B2B" id="B2B" value="<?php if(isset($B2B)){ echo $B2B;} ?>" title="B2B" placeholder="B2B">
                  </div>
