            ...
            <?php } ?>
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-12 branch">
                    <select class="form-control select2 form-control-sm" data-placeholder="Select Branch"  name="branch_id" title="Select Branch" id="branch_id" style="width: 100%;" required>
                      <option selected="selected" >Select Branch </option>
                      <?php foreach ($branch_list as $list) { ?>
                        <option value="<?php echo $list->branch_id; ?>" <?php if(isset($branch_id) && $branch_id == $list->branch_id){  echo "selected";  }  ?>><?php echo $list->branch_name; ?></option>
                      <?php } ?>
                      ...
                      <option value="<?php echo $list->user_id; ?>"
                        <?php if(isset($manager_id)) {
                          ...
                          foreach ($str_arr as $x) {
                            if($x == $list->user_id) { echo "selected"; }
                          }
                        } ?>
