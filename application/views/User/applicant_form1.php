              ...
              <form role="form">
                <div class="card-body row">
                  <div class="form-group col-md-8 offset-md-2">
                    <input type="text" class="form-control form-control-sm" name="" id="" placeholder="Full Name Of Applicant">
                  </div>
                  <div class="form-group col-md-8 offset-md-2">
                    <input type="text" class="form-control form-control-sm" name="" id="" placeholder="Nationality Of Applicant">
                  </div>
                  <div class="form-group col-md-8 offset-md-2">
                    <input type="text" class="form-control form-control-sm" name="" id="" placeholder="Father / Husabnt Of Applicant">
                  </div>
                  <div class="form-group col-md-8 offset-md-2">
                    <input type="text" class="form-control form-control-sm" name="" id="" placeholder="Residential Address">
                  </div>
                  <div class="form-group col-md-8 offset-md-2">
