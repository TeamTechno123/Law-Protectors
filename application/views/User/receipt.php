              ...
              <form role="form">
                <div class="card-body row">
                  <div class="form-group col-md-4 offset-md-2">
                    <input type="text" class="form-control form-control-sm" name="" id="" placeholder="Receipt No.">
                  </div>
                  <div class="form-group col-md-4">
                    <input type="text" class="form-control form-control-sm" name="" id="" placeholder="Receipt Date">
                  </div>
                  ...
                  <div class="form-group col-md-4 offset-md-2">
                    <input type="text" disabled class="form-control form-control-sm" name="" id="" placeholder="Outstanding Amount">
                  </div>
                  <div class="form-group col-md-4">
                    <input type="text" class="form-control form-control-sm" name="" id="" placeholder="Receipt Amount">
                  </div>
                  <div class="form-group col-md-8 offset-md-2">
